    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;overflow:hidden;border:1px solid rgba(74,53,92,0.15);">
          ...
          <!-- Status banner -->
          <tr>
            <td style="background-color:#E8F1FB;padding:14px 40px;text-align:center;">
              <p style="margin:0;color:#1A5FA8;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:1px;">
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 28px;color:#4A355C;font-size:15px;line-height:1.6;">
                Great news! Your package has been picked up and is currently in transit.
                Our delivery driver <strong>${distributorName}</strong> is on the way to you.
              </p>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="background-color:#EAF4EC;border:1px solid rgba(45,125,58,0.2);border-radius:8px;padding:16px;text-align:center;">
                          <p style="margin:0 0 4px;color:#2D7D3A;font-size:11px;font-weight:600;text-transform:uppercase;letter-spacing:1px;">Estimated Delivery</p>
                          <p style="margin:0;color:#12081A;font-size:16px;font-weight:700;">${estimatedDelivery}</p>
                        </td>
                      </tr>
                    </table>
                  </td>
