...
<head>
  ...
  <title>Reset your password — PakAG</title>
</head>
    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;overflow:hidden;border:1px solid rgba(74,53,92,0.15);">
          ...
          <!-- Status banner -->
          <tr>
            <td style="background-color:#FEF7E0;padding:14px 40px;text-align:center;">
              <p style="margin:0;color:#B07010;font-size:13px;font-weight:600;text-transform:uppercase;letter-spacing:1px;">
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 28px;color:#4A355C;font-size:15px;line-height:1.6;">
                We received a request to reset your PakAG password. Click the button below to set a new password.
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:28px;">
                <tr>
                  <td style="background-color:#FDEDEC;border:1px solid rgba(192,57,43,0.2);border-radius:8px;padding:16px 20px;">
                    <p style="margin:0;color:#C0392B;font-size:13px;line-height:1.6;">
                      <strong>Did not request this?</strong> If you did not request a password reset, you can safely ignore this email.
              ...
              <p style="margin:0;color:#4A355C;font-size:13px;line-height:1.6;">
                ...
                <a href="${changePasswordUrl}" style="color:#7B3FA0;word-break:break-all;">${changePasswordUrl}</a>
              </p>
            </td>
          </tr>
