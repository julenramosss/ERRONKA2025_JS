    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
        ...
        <div>
          ...
          <div style={{ color: "var(--text-secondary)", fontSize: 14 }}>
            ...
            <span style={{ color: "var(--accent-light)", fontWeight: 600 }}>
              {assigned + transit} paquetes pendientes
            </span>{" "}
            de entrega hoy · Ruta estimada {Math.round(24.8)} km
          </div>
        </div>
        <Btn
          variant="primary"
          icon={<I.Route size={16} />}
          onClick={() => onNav("ruta")}
        >
          Iniciar ruta
        </Btn>
      ...
      >
        ...
        <StatCard
          ...
          value={delivered}
          icon={<I.Check size={18} stroke={2.5} />}
        ...
        <StatCard
          ...
          bg="var(--st-transit-bg)"
        />
        <StatCard
          label="Fallidos hoy"
          value={0}
          icon={<I.AlertCircle size={18} />}
      ...
      {/* Map + Next deliveries */}
      <div
        style={{ display: "grid", gridTemplateColumns: "1.35fr 1fr", gap: 20 }}
        className="dash-grid"
      >
        ...
        <Card padding={0}>
          ...
          >
            ...
            <Btn variant="ghost" size="sm" onClick={() => onNav("paquetes")}>
              Ver todas
            </Btn>
          </div>
          <div>
      ...
      <Card padding={0}>
        ...
        <div style={{ padding: "20px 24px", position: "relative" }}>
          ...
          {[
            {
              time: "09:42",
              text: "Entregado a Itziar Etxeberria",
              detail: "PKG-261042 · Tolosa",
              status: "delivered",
            },
            {
              time: "09:18",
              text: "Entregado a Jon Aranburu",
              detail: "BLK-261043 · Aduna",
              status: "delivered",
            },
            {
              time: "08:55",
              text: "Iniciaste la entrega",
              detail: "AGT-261044 · Elduaien",
              status: "in_transit",
            },
            {
              time: "08:25",
              text: "Admin asignó 8 paquetes nuevos",
              detail: "Ruta del 19 abril",
              status: "assigned",
            },
          ].map((a, i) => (
            <div
